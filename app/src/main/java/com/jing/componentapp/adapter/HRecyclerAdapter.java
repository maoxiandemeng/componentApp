...
public class HRecyclerAdapter extends BaseRecyclerAdapter<FuLiBean> {
    public HRecyclerAdapter(Context context, ArrayList<FuLiBean> mData) {
        super(context, mData);
    }
    ...
    protected BaseViewHolder onCreate(ViewGroup parent, int viewType) {
        return new HomeHolder(LayoutInflater.from(context).inflate(R.layout.hrecycler_item, parent, false));
    }
