 ...
 */
public class DividerGridItemDecorationTwo extends RecyclerView.ItemDecoration {
    ...
    public DividerGridItemDecorationTwo(Context context) {
        final TypedArray a = context.obtainStyledAttributes(ATTRS);
        mDivider = a.getDrawable(0);
        a.recycle();
    }

    public DividerGridItemDecorationTwo(Context context, int drawableId) {
        this(context);
        mDivider = ContextCompat.getDrawable(context, drawableId);
        setOrientation(VERTICAL);
    }

    public DividerGridItemDecorationTwo(Context context, int orientation, int drawableId) {
        this(context);
        mDivider = ContextCompat.getDrawable(context, drawableId);
