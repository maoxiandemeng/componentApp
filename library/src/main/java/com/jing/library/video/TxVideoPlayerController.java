...
public class TxVideoPlayerController
        extends MyVideoPlayerController
    ...
    public void setVideoPlayer(IVideoPlayer niceVideoPlayer) {
        ...
        if (clarities != null && clarities.size() > 1) {
            mVideoPlayer.setVideoPath(clarities.get(defaultClarityIndex).videoUrl, null);
        }
    }
    ...
    protected void onPlayStateChanged(int playState) {
        switch (playState) {
            case MyVideoPlayer.STATE_IDLE:
                break;
            case MyVideoPlayer.STATE_PREPARING:
                ...
                break;
            case MyVideoPlayer.STATE_PREPARED:
                startUpdateProgressTimer();
                break;
            case MyVideoPlayer.STATE_PLAYING:
                mLoading.setVisibility(View.GONE);
                mRestartPause.setImageResource(R.drawable.ic_player_pause);
                startDismissTopBottomTimer();
                break;
            case MyVideoPlayer.STATE_PAUSED:
                mLoading.setVisibility(View.GONE);
                mRestartPause.setImageResource(R.drawable.ic_player_start);
                cancelDismissTopBottomTimer();
                break;
            case MyVideoPlayer.STATE_BUFFERING_PLAYING:
                mLoading.setVisibility(View.VISIBLE);
                mRestartPause.setImageResource(R.drawable.ic_player_pause);
                mLoadText.setText("正在缓冲...");
                startDismissTopBottomTimer();
                break;
            case MyVideoPlayer.STATE_BUFFERING_PAUSED:
                mLoading.setVisibility(View.VISIBLE);
                mRestartPause.setImageResource(R.drawable.ic_player_start);
                mLoadText.setText("正在缓冲...");
                cancelDismissTopBottomTimer();
                break;
            case MyVideoPlayer.STATE_ERROR:
                cancelUpdateProgressTimer();
                setTopBottomVisible(false);
                mTop.setVisibility(View.VISIBLE);
                mError.setVisibility(View.VISIBLE);
                break;
            case MyVideoPlayer.STATE_COMPLETED:
                cancelUpdateProgressTimer();
                setTopBottomVisible(false);
    ...
    protected void onPlayModeChanged(int playMode) {
        switch (playMode) {
            case MyVideoPlayer.MODE_NORMAL:
                ...
                break;
            case MyVideoPlayer.MODE_FULL_SCREEN:
                ...
                break;
            case MyVideoPlayer.MODE_TINY_WINDOW:
                mBack.setVisibility(View.VISIBLE);
                mClarity.setVisibility(View.GONE);
                break;
        }
    ...
    public void onClarityChanged(int clarityIndex) {
        ...
        mVideoPlayer.setVideoPath(clarity.videoUrl, null);
