...
public abstract class MyVideoPlayerController extends FrameLayout implements View.OnTouchListener{
     ...
     *                  <ul>
     *                  <li>{@link MyVideoPlayer#STATE_IDLE}</li>
     *                  <li>{@link MyVideoPlayer#STATE_PREPARING}</li>
     *                  <li>{@link MyVideoPlayer#STATE_PREPARED}</li>
     *                  <li>{@link MyVideoPlayer#STATE_PLAYING}</li>
     *                  <li>{@link MyVideoPlayer#STATE_PAUSED}</li>
     *                  <li>{@link MyVideoPlayer#STATE_BUFFERING_PLAYING}</li>
     *                  <li>{@link MyVideoPlayer#STATE_BUFFERING_PAUSED}</li>
     *                  <li>{@link MyVideoPlayer#STATE_ERROR}</li>
     *                  <li>{@link MyVideoPlayer#STATE_COMPLETED}</li>
     *                  </ul>
     */
     ...
     *                 <ul>
     *                 <li>{@link MyVideoPlayer#MODE_NORMAL}</li>
     *                 <li>{@link MyVideoPlayer#MODE_FULL_SCREEN}</li>
     *                 <li>{@link MyVideoPlayer#MODE_TINY_WINDOW}</li>
     *                 </ul>
     */
    ...
    protected void startUpdateProgressTimer() {
        ...
        if (mUpdateProgressTimerTask == null) {
            mUpdateProgressTimerTask = new TimerTask() {
                @Override
                public void run() {
                    MyVideoPlayerController.this.post(new Runnable() {
                        @Override
                        public void run() {
                            updateProgress();
                        }
