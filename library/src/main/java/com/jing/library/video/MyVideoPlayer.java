...
public class MyVideoPlayer extends FrameLayout implements IVideoPlayer, TextureView.SurfaceTextureListener {
    ...
    private MyVideoPlayerController mController;
    ...
    public void setController(MyVideoPlayerController controller) {
    ...
    public void start() {
        if (mCurrentState == STATE_IDLE) {
            ...
            Log.d(TAG, "MyVideoPlayer只有在mCurrentState == STATE_IDLE时才能调用start方法.");
        }
    }
    ...
    public void restart() {
        if (mCurrentState == STATE_PAUSED) {
            ...
            Log.d(TAG, "MyVideoPlayer在mCurrentState == " + mCurrentState + "时不能调用restart()方法.");
        }
    }
