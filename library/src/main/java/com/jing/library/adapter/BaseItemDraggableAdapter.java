...
import com.jing.library.adapter.callback.ItemDragAndSwipeCallback;
import com.jing.library.adapter.listener.OnItemDragListener;
import com.jing.library.adapter.listener.OnItemSwipeListener;
...
public abstract class BaseItemDraggableAdapter<T> extends BaseRecyclerAdapter {
    ...
    protected BaseItemDraggableAdapter(Context context, ArrayList<T> mData) {
        super(context, mData);
    }
    ...
    public void onBindViewHolder(BaseViewHolder holder, int position) {
        ...
        if (mItemTouchHelper != null && itemDragEnabled && viewType != TYPE_HEADER && viewType != TYPE_EMPTY) {
            if (mToggleViewId != NO_TOGGLE_VIEW) {
                View toggleView = holder.getView(mToggleViewId);
                if (toggleView != null) {
                    toggleView.setTag(R.id.adapter_viewholder_support, holder);
                    if (mDragOnLongPress) {
                ...
                holder.itemView.setTag(R.id.adapter_viewholder_support, holder);
            ...
            mOnToggleViewLongClickListener = new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (mItemTouchHelper != null && itemDragEnabled) {
                        mItemTouchHelper.startDrag((RecyclerView.ViewHolder) v.getTag(R.id.adapter_viewholder_support));
                    }
                    return true;
                }
            };
