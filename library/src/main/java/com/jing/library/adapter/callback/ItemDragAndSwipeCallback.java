package com.jing.library.adapter.callback;
...
import com.jing.library.adapter.BaseItemDraggableAdapter;
...
public class ItemDragAndSwipeCallback extends ItemTouchHelper.Callback {
    ...
    private boolean isViewCreateByAdapter(RecyclerView.ViewHolder viewHolder) {
        ...
        if (type == mAdapter.TYPE_HEADER || type == mAdapter.TYPE_EMPTY) {
            return true;
        }
        return false;
