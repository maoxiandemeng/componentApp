package com.jing.library.viewpager;
...
public class LoopViewPager extends ViewPager {
    ...
    private int mDelayTime = 6000; //轮播的延时时间
    ...
    public LoopViewPager(Context context, AttributeSet attrs) {
        ...
        mIsAutoLoop = a.getBoolean(R.styleable.LoopViewPager_isAutoLoop, mIsAutoLoop);
        mDelayTime = a.getInteger(R.styleable.LoopViewPager_delayTime, mDelayTime);
        a.recycle();
